...
export const PostRoundArchive: React.FC<PostRoundArchiveProps> = ({
  ...
  // Temporizador de auto-avance (7 segundos exactos)
  ...
  return (
    <div className="w-full max-w-6xl mx-auto flex flex-col gap-3 sm:gap-5 py-2 sm:py-3 animate-in fade-in duration-300">
      {/* 1. Header de Estado del Match + Barra de Auto-Avance (7 Segundos) */}
      <div className="flex flex-col gap-1.5 bg-zinc-900/90 border border-zinc-800 p-2.5 sm:p-3.5 rounded-xl sm:rounded-2xl font-mono text-xs shadow-lg">
        <div className="flex flex-wrap items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1.5 bg-amber-500/15 border border-amber-500/40 text-amber-300 px-2.5 py-1 rounded-lg text-[10px] sm:text-[11px] font-bold animate-pulse">
              ...
              <span>Siguiente en {autoAdvanceSeconds}s</span>
            </div>
          </div>
        </div>
        ...
        <div className="w-full bg-zinc-950 h-1.5 rounded-full overflow-hidden">
          <div
            ...
            style={{ width: `${(autoAdvanceSeconds / 7) * 100}%` }}
          />
        </div>
      </div>
      ...
      <div
        className={`w-full p-3.5 sm:p-5 rounded-xl sm:rounded-2xl border flex flex-col md:flex-row items-center justify-between gap-3 shadow-2xl ${
          isPlayerWinner
      ...
      >
        <div className="flex items-center gap-3 w-full md:w-auto">
          <div
            className={`p-2.5 sm:p-3.5 rounded-full shrink-0 ${
              isPlayerWinner
          ...
          <div className="flex flex-col min-w-0">
            ...
            <h2 className="text-lg sm:text-2xl font-serif font-bold text-zinc-100 truncate">
        ...
        <div className="flex items-center justify-center gap-4 sm:gap-6 bg-zinc-950/70 px-4 sm:px-6 py-2 rounded-xl border border-zinc-800 font-mono w-full md:w-auto shrink-0">
          <div className="flex flex-col items-center">
            <span className="text-[9px] sm:text-[10px] text-zinc-400">TUS PUNTOS</span>
          ...
          <div className="flex flex-col items-center">
            <span className="text-[9px] sm:text-[10px] text-zinc-400">RIVAL</span>
            <span className="text-xl sm:text-2xl font-black text-zinc-300">
      ...
      {/* 3. Telemetría de Ventaja del Rival (¿Por qué ganó?) */}
      {!isPlayerWinner && (
        <div className="bg-red-950/40 border border-red-500/60 rounded-xl sm:rounded-2xl p-3 sm:p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5 shadow-lg">
          <div className="flex items-start gap-2.5">
            <div className="p-1.5 bg-red-500/20 text-red-400 rounded-lg shrink-0 mt-0.5">
              <Flame className="w-4 h-4 text-red-400" />
            </div>
            <div className="flex flex-col gap-0.5">
              <span className="font-mono text-[10px] sm:text-xs text-red-300 font-bold uppercase tracking-wider">
                ¿POR QUÉ GANÓ EL RIVAL ESTA RONDA?
              </span>
              <p className="text-xs sm:text-sm font-sans text-zinc-200">
          ...
          {unansweredCount > 0 && (
            <div className="flex items-center gap-1.5 bg-zinc-950 px-2.5 py-1 rounded-lg border border-red-500/50 text-red-400 text-[10px] sm:text-xs font-mono shrink-0 self-end sm:self-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 sm:gap-5 items-start">
        ...
        <div className="lg:col-span-7 flex flex-col gap-1.5">
          ...
          <div className="h-[280px] sm:h-[380px] w-full rounded-xl overflow-hidden">
            <DeepZoomViewer
        ...
        <div className="lg:col-span-5 flex flex-col gap-2.5">
          ...
          <div className="bg-[#12151b] border border-zinc-800 rounded-xl p-3 sm:p-4 flex flex-col gap-2 shadow-xl">
            <div className="flex items-center justify-between border-b border-zinc-800 pb-1.5">
              <span className="font-mono text-[11px] text-amber-400 tracking-widest uppercase font-bold flex items-center gap-1.5">
            ...
            <div className="bg-amber-950/20 border border-amber-700/30 rounded-lg p-2 text-[11px] text-amber-200/90 font-sans">
          ...
          <div className="bg-[#12151b] border border-zinc-800 rounded-xl p-3 flex flex-col gap-1.5 font-mono text-[11px]">
            ...
            <div className="flex justify-between items-center text-[9px] sm:text-[10px] text-zinc-400 pt-1 border-t border-zinc-800">
