...
export const CANONICAL_EVIDENCES: CanonicalEvidence[] = [
  ...
  // 21. MARÍTIMO: Hundimiento del RMS Lusitania (1915)
  {
    ...
    image_url: '/evidences/lusitania_1915.jpg',
    image_hd_url: '/evidences/lusitania_1915.jpg',
    image_aspect_ratio: 1.45,
    image_source: {
      institution: 'Library of Congress',
  ...
  // 22. ESPACIO: Lanzamiento del Sputnik 1 (1957)
  {
    ...
    image_url: '/evidences/sputnik_1957.jpg',
    image_hd_url: '/evidences/sputnik_1957.jpg',
    image_aspect_ratio: 1.35,
    image_source: {
  ...
  // 23. ESPACIO: Vuelo de Yuri Gagarin en el Vostok 1 (1961)
  {
    ...
    image_url: '/evidences/gagarin_1961.jpg',
    image_hd_url: '/evidences/gagarin_1961.jpg',
    image_aspect_ratio: 1.35,
    image_source: {
  ...
  // 24. GUERRA MUNDIAL: Desembarco de Normandía / Día D (1944)
  {
    ...
    image_url: '/evidences/normandia_1944.jpg',
    image_hd_url: '/evidences/normandia_1944.jpg',
    image_aspect_ratio: 1.35,
    image_source: {
  ...
  // 25. GUERRA MUNDIAL: Alzamiento de la Bandera en Iwo Jima (1945)
  {
    ...
    image_url: '/evidences/iwojima_1945.jpg',
    image_hd_url: '/evidences/iwojima_1945.jpg',
  ...
  // 26. GUERRA MUNDIAL: Bandera de la Victoria sobre el Reichstag (1945)
  {
    ...
    image_url: '/evidences/reichstag_1945.jpg',
    image_hd_url: '/evidences/reichstag_1945.jpg',
    image_aspect_ratio: 1.35,
    image_source: {
  ...
  // 27. TRATADO: Firma del Tratado de Versalles (1919)
  {
    ...
    image_url: '/evidences/versalles_1919.jpg',
    image_hd_url: '/evidences/versalles_1919.jpg',
    image_aspect_ratio: 1.45,
    image_source: {
  ...
  // 28. CUMBRE: Conferencia de Potsdam (1945)
  {
    ...
    image_url: '/evidences/potsdam_1945.jpg',
    image_hd_url: '/evidences/potsdam_1945.jpg',
    image_aspect_ratio: 1.4,
    image_source: {
  ...
  // 29. JUSTICIA: Juicios de Núremberg (1945/1946)
  {
    ...
    image_url: '/evidences/nuremberg_1945.jpg',
    image_hd_url: '/evidences/nuremberg_1945.jpg',
    image_aspect_ratio: 1.4,
    image_source: {
  ...
  // 30. COMPUTACIÓN: Presentación de la ENIAC (1946)
  {
    ...
    image_url: '/evidences/eniac_1946.jpg',
    image_hd_url: '/evidences/eniac_1946.jpg',
    image_aspect_ratio: 1.45,
    image_source: {
  ...
  // 31. ARQUITECTURA: Inauguración del Puente Golden Gate (1937)
  {
    ...
    image_url: '/evidences/goldengate_1937.jpg',
    image_hd_url: '/evidences/goldengate_1937.jpg',
    image_aspect_ratio: 1.45,
    image_source: {
  ...
  // 32. TRAGEDIA: Desastre del Dirigible Hindenburg (1937)
  {
    ...
    image_url: '/evidences/hindenburg_1937.jpg',
    image_hd_url: '/evidences/hindenburg_1937.jpg',
    image_aspect_ratio: 1.3,
    image_source: {
      institution: 'Associated Press / US National Archives',
  ...
  // 33. ARQUEOLOGÍA: Descubrimiento de la Tumba de Tutankamón (1922)
  {
    ...
    image_url: '/evidences/tutankamon_1922.jpg',
    image_hd_url: '/evidences/tutankamon_1922.jpg',
    image_aspect_ratio: 1.35,
    image_source: {
  ...
  // 34. CIENCIA: Primera Radiografía Médica por Röntgen (1895)
  {
    ...
    image_url: '/evidences/rontgen_1895.jpg',
    image_hd_url: '/evidences/rontgen_1895.jpg',
    image_aspect_ratio: 1.25,
    image_source: {
  ...
  // 35. CIENCIA: Descubrimiento de la Estructura del ADN (1953)
  {
    ...
    image_url: '/evidences/adn_1953.jpg',
    image_hd_url: '/evidences/adn_1953.jpg',
    image_aspect_ratio: 1.0,
    image_source: {
  ...
  // 36. AVIACIÓN: Vuelo Transatlántico de Charles Lindbergh (1927)
  {
    ...
    image_url: '/evidences/lindbergh_1927.jpg',
    image_hd_url: '/evidences/lindbergh_1927.jpg',
    image_aspect_ratio: 1.4,
    image_source: {
  ...
  // 37. GUERRA: Armisticio de Compiègne (1918)
  {
    ...
    image_url: '/evidences/armisticio_1918.jpg',
    image_hd_url: '/evidences/armisticio_1918.jpg',
    image_aspect_ratio: 1.45,
    image_source: {
  ...
  // 38. GUERRA FRÍA: Crisis de los Misiles en Cuba (1962)
  {
    ...
    image_url: '/evidences/misiles_1962.jpg',
    image_hd_url: '/evidences/misiles_1962.jpg',
    image_aspect_ratio: 1.35,
    image_source: {
  ...
  // 39. ARGENTINA: Edificio Kavanagh (1936)
  {
    ...
    image_url: '/evidences/kavanagh_1936.jpg',
    image_hd_url: '/evidences/kavanagh_1936.jpg',
    image_aspect_ratio: 1.35,
    image_source: {
  ...
  // 40. ARGENTINA: Bombardeo de Plaza de Mayo (1955)
  {
    ...
    image_url: '/evidences/bombardeo_1955.jpg',
    image_hd_url: '/evidences/bombardeo_1955.jpg',
    image_aspect_ratio: 1.45,
    image_source: {
      institution: 'Archivo General de la Nación (AGN)',
  ...
  // 41. ARGENTINA: Teatro Colón (1908)
  {
    ...
    image_url: '/evidences/colon_1908.jpg',
    image_hd_url: '/evidences/colon_1908.jpg',
    image_aspect_ratio: 1.45,
    image_source: {
      institution: 'Archivo General de la Nación (AGN)',
  ...
  // 42. ARGENTINA: La Porteña / Primer Ferrocarril (1857)
  {
    ...
    image_url: '/evidences/portena_1857.jpg',
    image_hd_url: '/evidences/portena_1857.jpg',
    image_aspect_ratio: 1.45,
    image_source: {
  ...
  // 43. INDEPENDENCIA: Declaración de la Independencia en Tucumán (1816)
  {
    ...
    image_url: '/evidences/tucuman_1816.jpg',
    image_hd_url: '/evidences/tucuman_1816.jpg',
    image_aspect_ratio: 1.45,
    image_source: {
  ...
  // 44. ARGENTINA: Combate de San Lorenzo (1813)
  {
    ...
    image_url: '/evidences/sanlorenzo_1813.jpg',
    image_hd_url: '/evidences/sanlorenzo_1813.jpg',
    image_aspect_ratio: 1.45,
    image_source: {
      institution: 'Museo Histórico Nacional / Augusto Ballerini',
  ...
  // 45. ARGENTINA: Asunción de Perón (1946)
  {
    ...
    image_url: '/evidences/asuncion_1946.jpg',
    image_hd_url: '/evidences/asuncion_1946.jpg',
    image_aspect_ratio: 1.4,
    image_source: {
      institution: 'Archivo General de la Nación (AGN)',
  ...
  // 46. ARGENTINA: Funeral de Eva Perón (1952)
  {
    ...
    image_url: '/evidences/evaperon_1952.jpg',
    image_hd_url: '/evidences/evaperon_1952.jpg',
    image_aspect_ratio: 1.4,
    image_source: {
      institution: 'Archivo General de la Nación (AGN)',
  ...
  // 47. ARGENTINA: Noche de los Bastones Largos (1966)
  {
    ...
    image_url: '/evidences/bastones_1966.jpg',
    image_hd_url: '/evidences/bastones_1966.jpg',
    image_aspect_ratio: 1.45,
    image_source: {
      institution: 'Archivo General de la Nación (AGN)',
  ...
  // 48. ARGENTINA: Conflicto de Malvinas (1982)
  {
    ...
    image_url: '/evidences/malvinas_1982.jpg',
    image_hd_url: '/evidences/malvinas_1982.jpg',
    image_aspect_ratio: 1.4,
    image_source: {
  ...
  // 49. LATINOAMÉRICA: Revolución Cubana en La Habana (1959)
  {
    ...
    image_url: '/evidences/cuba_1959.jpg',
    image_hd_url: '/evidences/cuba_1959.jpg',
    image_aspect_ratio: 1.35,
    image_source: {
  ...
  // 50. LATINOAMÉRICA: Masacre de Tlatelolco (1968)
  {
    ...
    image_url: '/evidences/tlatelolco_1968.jpg',
    image_hd_url: '/evidences/tlatelolco_1968.jpg',
    image_aspect_ratio: 1.4,
    image_source: {
  ...
  // 51. DERECHOS: Gran Marcha Sufragista (1913)
  {
    ...
    image_url: '/evidences/sufragistas_1913.jpg',
    image_hd_url: '/evidences/sufragistas_1913.jpg',
    image_aspect_ratio: 1.35,
    image_source: {
      institution: 'Library of Congress',
  ...
  // 52. CULTURA: Festival de Woodstock (1969)
  {
    ...
    image_url: '/evidences/woodstock_1969.jpg',
    image_hd_url: '/evidences/woodstock_1969.jpg',
    image_aspect_ratio: 1.45,
    image_source: {
  ...
  // 53. FOTOGRAFÍA: Almuerzo sobre un Rascacielos (1932)
  {
    ...
    image_url: '/evidences/lunchrock_1932.jpg',
    image_hd_url: '/evidences/lunchrock_1932.jpg',
    image_aspect_ratio: 1.35,
    image_source: {
  ...
  // 54. DIPLOMACIA: Carta de la ONU (1945)
  {
    ...
    image_url: '/evidences/onu_1945.jpg',
    image_hd_url: '/evidences/onu_1945.jpg',
    image_aspect_ratio: 1.4,
    image_source: {
  ...
  // 55. MONUMENTO: Estatua de la Libertad (1886)
  {
    ...
    image_url: '/evidences/libertad_1886.jpg',
    image_hd_url: '/evidences/libertad_1886.jpg',
    image_aspect_ratio: 1.45,
    image_source: {
  ...
  // 56. TELECOMUNICACIONES: Telégrafo de Marconi (1901)
  {
    ...
    image_url: '/evidences/marconi_1901.jpg',
    image_hd_url: '/evidences/marconi_1901.jpg',
    image_aspect_ratio: 1.35,
    image_source: {
  ...
  // 57. PROTESTAS: El Hombre del Tanque en Tiananmén (1989)
  {
    ...
    image_url: '/evidences/tiananmen_1989.jpg',
    image_hd_url: '/evidences/tiananmen_1989.jpg',
    image_aspect_ratio: 1.45,
    image_source: {
