...
export const CANONICAL_EVIDENCES: CanonicalEvidence[] = [
  ...
  },
  {
    ...
    image_aspect_ratio: 1.45,
    image_source: {
      institution: 'Library of Congress / AGN',
      collection_id: 'Colección Centenario 1910',
      source_type: 'PRIMARY_PHOTO',
      rights_license: 'PUBLIC_DOMAIN',
      rights_holder: 'Dominio Público',
    },
    ...
    canonical_location: {
      ...
      country_code: 'AR',
      country_name: 'Argentina',
      display_location: 'Buenos Aires en 1910',
    },
    geographic_scope: 'ARGENTINA',
    thematic_category: 'POLITICA',
    difficulty_tier: 2,
    visual_clues: [
      {
        id: 'clue-1',
        title: 'Arquitectura y Gala de Época en Buenos Aires',
        category: 'architecture',
        normalized_rect: { x: 0.20, y: 0.15, width: 0.60, height: 0.55 },
        observation_text: 'Carruajes, vestimentas de principios de siglo y arboledas ornamentales del Centenario.',
        deduction_text: 'La atmósfera urbana de Buenos Aires en 1910 para los festejos patrios del Centenario.',
        time_penalty_seconds: 7,
      },
      {
        id: 'clue-2',
        title: 'Carruajes y Paseo de Mayo de 1910',
        category: 'technology',
        normalized_rect: { x: 0.05, y: 0.55, width: 0.45, height: 0.35 },
        observation_text: 'Coches de época y transeúntes con sombreros galera y trajes de gala.',
        deduction_text: 'El transporte a tracción y la indumentaria sitúan la escena en mayo de 1910.',
        time_penalty_seconds: 6,
      }
    ],
    editorial_status: 'READY_FOR_COMPETITIVE',
    primary_sources: [
      {
        institution: 'Library of Congress / AGN',
        collection_id: 'Prints and Photographs Division, 1910',
        source_type: 'PRIMARY_DOCUMENT',
        rights_license: 'PUBLIC_DOMAIN',
        rights_holder: 'Library of Congress',
      }
    ...
    historical_context_brief: 'En mayo de 1910, Argentina celebró el primer centenario de la Revolución de Mayo de 1810 con fastuosos desfiles militares y visitas de dignatarios internacionales en Buenos Aires.',
    deduction_pathway: 'La indumentaria de época, los carruajes y las avenidas porteñas de 1910 sitúan la escena en las fiestas del Centenario de Mayo.',
    verified_at: '2026-08-17T00:00:00Z',
  }
];
