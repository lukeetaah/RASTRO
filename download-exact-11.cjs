...
const TARGETS = [
  { file: 'asuncion_1946.jpg', wiki: 'es', search: 'Juan_Domingo_Perón' },
  { file: 'cuba_1959.jpg', wiki: 'es', search: 'Revolución_cubana' },
  { file: 'evaperon_1952.jpg', wiki: 'es', search: 'Eva_Perón' },
  { file: 'goldengate_1937.jpg', wiki: 'en', search: 'Golden_Gate_Bridge' },
  { file: 'libertad_1886.jpg', wiki: 'en', search: 'Statue_of_Liberty' },
  { file: 'onu_1945.jpg', wiki: 'en', search: 'United_Nations_Charter' },
  { file: 'sufragistas_1913.jpg', wiki: 'en', search: 'Woman_Suffrage_Procession' },
  { file: 'tiananmen_1989.jpg', wiki: 'en', search: 'Tank_Man' },
  { file: 'tucuman_1816.jpg', wiki: 'es', search: 'Casa_Histórica_de_la_Independencia' },
  { file: 'versalles_1919.jpg', wiki: 'en', search: 'Treaty_of_Versailles' },
  { file: 'woodstock_1969.jpg', wiki: 'en', search: 'Woodstock' }
];
...
async function run() {
  console.log('Downloading the 11 missing images with official Wikimedia API...');
  
  for (const item of TARGETS) {
    const dest = path.join(outDir, item.file);
    try {
      // 1. Get page images list
      ...
      // If no lead thumbnail, find first valid image in page images list
  ...
  console.log('🏁 All 11 files verified and saved!');
}
